...
class TestCdswRunnerJobsE2E(unittest.TestCase):
    ...
    @staticmethod
    def _create_args_for_specified_file(config_file: str, cmd_type: str, dry_run: bool = True):
        args = Object()
    ...
    def test_reviewsync_e2e(self):
        ...
        args = self._create_args_for_specified_file(config_file, "reviewsync", dry_run=True)
        ...
        exp_command_1 = (
            ...
            .with_command_type("reviewsync")
        )

        exp_command_2 = self._get_expected_zip_latest_command_data_command("reviewsync")
    ...
    def test_review_sheet_backport_updater_e2e(self):
        ...
        args = self._create_args_for_specified_file(
            config_file, "review_sheet_backport_updater", dry_run=True
        )
        cdsw_runner_config = CdswRunnerConfig(PARSER, args, config_reader=CdswConfigReaderAdapter())
        cdsw_runner = FakeCdswRunner(cdsw_runner_config)
        cdsw_runner.start()
        ...
        exp_command_1 = (
            ...
            .add_expected_arg("--gsheet-status-info-column", "testGsheetStatusInfoColumn")
            .add_expected_arg("--branches", "branch-3.2 branch-3.3")
            .with_command_type("review_sheet_backport_updater")
        )
    ...
    def test_unit_test_result_fetcher_e2e(self):
        ...
        wrap_d = StringUtils.wrap_to_quotes
        args = self._create_args_for_specified_file(config_file, "unit_test_result_fetcher", dry_run=True)
        cdsw_runner_config = CdswRunnerConfig(PARSER, args, config_reader=CdswConfigReaderAdapter())
        cdsw_runner = FakeCdswRunner(cdsw_runner_config)
        cdsw_runner.start()
        ...
        exp_command_1 = (
            ...
            .with_command_type("unit_test_result_fetcher")
        )

        expectations = [exp_command_1]
        CdswTestingCommons.verify_commands(self, expectations, cdsw_runner.executed_commands)

    def _get_expected_zip_latest_command_data_command(self, cmd_type: str):
        exp_command_2 = (
            CommandExpectations(self)
            .add_expected_ordered_arg("python3")
            .add_expected_ordered_arg(self.yarn_dev_tools_script_path)
            .add_expected_ordered_arg("ZIP_LATEST_COMMAND_DATA")
            .add_expected_ordered_arg(cmd_type)
            .add_expected_arg("--debug")
            .add_expected_arg("--dest_dir", "/tmp")
            .add_expected_arg("--ignore-filetypes", "java js")
            .with_command_type("zip_latest_command_data")
    ...
    def test_jira_umbrella_data_fetcher_e2e(self):
        ...
        args = self._create_args_for_specified_file(config_file, "jira_umbrella_data_fetcher", dry_run=True)
        cdsw_runner_config = CdswRunnerConfig(PARSER, args, config_reader=CdswConfigReaderAdapter())
        cdsw_runner = FakeCdswRunner(cdsw_runner_config)
        cdsw_runner.start()
        ...
        exp_command_2 = self._get_expected_zip_latest_command_data_command("jira_umbrella_data_fetcher")
        ...
        exp_command_5 = self._get_expected_zip_latest_command_data_command("jira_umbrella_data_fetcher")
    ...
    def test_unit_test_result_aggregator_e2e(self):
        ...
        args = self._create_args_for_specified_file(config_file, "unit_test_result_aggregator", dry_run=True)
        cdsw_runner_config = CdswRunnerConfig(PARSER, args, config_reader=CdswConfigReaderAdapter())
        cdsw_runner = FakeCdswRunner(cdsw_runner_config)
        cdsw_runner.start()
        ...
        exp_command_1 = (
            ...
            .with_command_type("unit_test_result_aggregator")
        )
        exp_command_2 = self._get_expected_zip_latest_command_data_command("unit_test_result_aggregator")
        exp_command_3 = self._get_expected_send_latest_command_data_command(
    ...
    def test_branch_comparator_e2e(self):
        ...
        args = self._create_args_for_specified_file(config_file, "branch_comparator", dry_run=True)
        ...
        exp_command_1_1 = (
            ...
            .with_command_type("branch_comparator")
        )
        exp_command_2_1 = (
            CommandExpectations(self)
            .add_expected_ordered_arg("python3")
    ...
    def _get_expected_jira_umbrella_data_fetcher_main_command(self, umbrella_id: str):
        exp_command_1 = (
            ...
            .with_command_type("jira_umbrella_data_fetcher")
        )
